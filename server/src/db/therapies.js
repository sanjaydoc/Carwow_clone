...
export const therapies = [
  ...
  {
    make: 'Nephrology', model: 'Persona Reversal Renal Epigenetic Reprogramming', trim: 'OSK partial reprogramming (OCT4 · SOX2 · KLF4)', year: 2026,
  ...
  {
    make: 'Orthopedics', model: 'Muse Cell Cartilage Repair', trim: 'Allogeneic Muse cells', year: 2024,
    price: 15000, monthly_price: 625, body_type: 'Muse', fuel_type: 'Allogeneic', transmission: 'Intra-articular injection',
    mileage: 60, color: 'Day-case', condition: 'used', seats: 30, doors: 2,
    engine: 'Bone-marrow / adipose-derived Muse cells', power_bhp: 55, zero_to_sixty: 1, top_speed: 14,
    economy_mpg: 12, rating: 4.1, review_count: 40, accent: ORTHO,
