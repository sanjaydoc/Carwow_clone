...
const BRANDS = [
  'Age Rejuvenation', 'Oncology', 'Diabetes', 'HIV', 'Autoimmune', 'Dental', 'Orthopedics',
...
const established: {
  ...
  { name: 'Luxturna', generic: 'Voretigene neparvovec (AAV)', kind: 'Gene therapy', indication: 'Inherited retinal dystrophy (RPE65)', approval: 'FDA · 2017', motif: 'eye', img: 'luxturna.jpg' },
  ...
  { name: 'Ryoncil', generic: 'Remestemcel-L (MSC)', kind: 'Stem cell', indication: 'Steroid-refractory acute GvHD', approval: 'FDA · 2024', motif: 'shield', img: 'ryoncil.jpg' },
  ...
  { name: 'Elevidys', generic: 'Delandistrogene moxeparvovec (AAV)', kind: 'Gene therapy', indication: 'Duchenne muscular dystrophy', approval: 'FDA · 2023', motif: 'muscle', img: 'elevidys.jpg' },
...
export default function Home() {
  ...
  useEffect(() => {
    ...
    // Featured-therapies slider: Persona Reversal, Muse cells, CAR-T, Exosome IV, Type 1 Diabetes, HIV cure.
    Promise.all([
      api.getCars({ search: 'Persona Reversal', limit: 1 }),
      api.getCars({ search: 'Muse', limit: 1 }),
      api.getCars({ make: 'Oncology', limit: 1 }),
  ...
  const posterTitle = (p: Car) =>
    p.make === 'HIV' ? 'HIV Cure'
      : p.make === 'Oncology' ? 'CAR-T Cell Therapy'
      : /Muse/i.test(p.model) ? 'Muse Cells'
      : /Persona Reversal/i.test(p.model) ? 'Persona Reversal (age reversal)'
      : p.model;
