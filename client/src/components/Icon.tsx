...
export default function Icon({ name, className = 'h-6 w-6' }: { name: IconName; className?: string }) {
  ...
  switch (name) {
    ...
    case 'brain':
      return (
        <svg {...p} {...stroke}>
          <path d="M12 5a2.5 2.5 0 0 0-2.5 2.5c-1.4.2-2.5 1.4-2.5 2.9 0 .8.3 1.5.8 2-.5.5-.8 1.2-.8 2 0 1.6 1.3 2.9 2.9 2.9.4 1 1.4 1.7 2.6 1.7" />
          <path d="M12 5a2.5 2.5 0 0 1 2.5 2.5c1.4.2 2.5 1.4 2.5 2.9 0 .8-.3 1.5-.8 2 .5.5.8 1.2.8 2 0 1.6-1.3 2.9-2.9 2.9-.4 1-1.4 1.7-2.6 1.7" />
          <path d="M12 5v14" />
        </svg>
      );
    case 'dish':
